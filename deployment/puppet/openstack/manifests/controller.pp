...
class openstack::controller (
  ...
  if ($db_type == 'mysql') {
    ...
    class { 'openstack::db::mysql':
      ...
      quantum                => $quantum,
      quantum_db_user        => $quantum ? { true => $quantum_config['database']['username'], default=>undef},
      quantum_db_password    => $quantum ? { true => $quantum_config['database']['passwd'], default=>""},
      quantum_db_dbname      => $quantum ? { true => $quantum_config['database']['dbname'], default=>undef},
