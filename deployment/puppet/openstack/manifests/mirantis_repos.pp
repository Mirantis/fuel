...
class openstack::mirantis_repos (
  ...
  $grizzly_baseurl           = 'http://download.mirantis.com/epel-fuel-grizzly-current/',
    ...
    'RedHat': {
      ...
      if $type == 'default' {
        ...
        yumrepo { 'centos-base':
            ...
            name       => 'base',
            baseurl    => 'http://download.mirantis.com/epel-fuel-grizzly-current',
            gpgcheck   => '1',
            gpgkey     => 'http://download.mirantis.com/epel-fuel-grizzly-current/mirantis.key',
            mirrorlist => absent,
        }
