...
describe Puppet::Type.type(:cs_colocation) do
  subject do
    Puppet::Type.type(:cs_colocation)
  end
  ...
  describe "basic structure" do
    it "should be able to create an instance" do
      provider_class = Puppet::Type::Cs_colocation.provider(Puppet::Type::Cs_colocation.providers[0])
      Puppet::Type::Cs_colocation.expects(:defaultprovider).returns(provider_class)
