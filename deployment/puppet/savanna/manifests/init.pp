class savanna (
  ...
  $savanna_use_neutron                  = 'False',
  $savanna_floating_ips_auto_assigment  = 'True',
) {
  ...
  class { 'savanna::api':
    ...
    use_neutron                         => $savanna_use_neutron,
  }
  ...
  class { 'savanna::dashboard' :
    ...
    floating_ips_auto_assigment         => $savanna_floating_ips_auto_assigment,
    use_neutron                         => $savanna_use_neutron,
